// Structure of Arrays (SoA) for hot fields used in queries
#include <vector>
#include <string>

extern std::vector<std::string> g_complaintTypeLower;
extern std::vector<double> g_latitude;
extern std::vector<double> g_longitude;
#pragma once
#include <cstdint>
#include <string>
#include <vector>
...
struct ServiceRequest {
    ...
    std::string complaintTypeLower;     // lowercased complaint type for fast case-insensitive search
